...
import CardCollected from "@/components/CardCollected";
...
export default function UserReferred() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View
          style={{ padding: scale(24), gap: scale(24), alignItems: "center" }}
        >
          <View
            className="header"
            style={{
          ...
          >
            ...
            >
              <Rect width="48" height="48" rx="24" fill="#F7FAF6" />
              <Path
          ...
          {!cardCollected ? (
            <View style={{ alignItems: "center" }}>
              ...
              >
                <Text style={{ color: "#5CC738" }}>Manny</Text> has joined Over
              </Text>
              <Text
                style={{
          ...
          >
            <Image
              source={require("@/assets/images/headshot-1.png") as any}
              style={{
                width: scale(64),
                height: scale(64),
              }}
            ...
            <Image
              source={require("@/assets/images/diamond.png") as any}
              style={{
